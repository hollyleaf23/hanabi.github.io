...
- For example, in a 4-player game:
  ...
  - Cathy discards.
  - From Donald's perspective, since red (the type of clue that was given) does not connect to blue (the card that was blind-played), this must be a _Bluff_. Normally, since the red 1 is currently played on the stacks, Donald would think that he has the red 3 (the _one-away-from-playable_ red card).
