...
- For example, in the section for the _Reverse Trash Finesse_, Bob is forced into discarding his 2. It turned out to be a green 2, which means that Alice's clue was a _Trash Finesse_, which means that a _Chop Move_ happens.
