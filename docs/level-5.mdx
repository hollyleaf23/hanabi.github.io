...
- For example, in a 5-player game:
  ...
  - Cathy knows that Alice is performing a _Finesse_ and that she must have the red 2. Cathy's first instinct is to blind-play the red 2. This is urgent because otherwise, Emily will think that her red card might be the red 2, and it would misplay.
